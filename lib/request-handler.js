...
exports.getFriends = (req, res) => {
  ...
  var peopleId = [];
   ...
   Rating.query( qb =>{
    ...
    .fetchAll()
    .then(res=>{
      console.log("this is resultss", res, "this is resultss");
    });

    Rating.forge({userid:userid}).fetchAll().then(results=>{
        console.log("this is 2resultss", results, "this is 2resultss");
    });

    new Rating({userid:userid}).fetchAll().then(rez=>{
      console.log("this is 3resultss", rez, "this is 3resultss");
    });
