...
class SingleMovieRating extends Component {
  ...
  render() {
    ...
    return (
      <div> <button className="goBack center waves-effect waves-light btn" onClick={()=>{this.props.changeViews(this.props.whence||"MyRatings")}}>Go back to {this.props.whence==="Home"?"Recent Releases":"All Rated Movies"}</button>
